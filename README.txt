...
test run instructions:
	...
	5. Copy the "upload test pictures" folder in the "upload" test folder and all of its contents into your C: drive so that the files inside can be found via the path "C:\upload test pictures\[file]".
